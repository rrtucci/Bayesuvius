...
\beq\color{blue}
P(y|A^n)= \delta(y, 1-(1-\lam) \A_{i=0}^{n-1}
\ol{A}_i)=
\delta(y, 1 - (1-\lam) \prod_{0}^{n-1}(1-A_i))
\eeq
...
\left[
 1 - (1-\lam) 
\prod_{0}^{n-1}(1-A_i)\right]
\delta(A_i, h_i[s] x_i)P(h^n[s])
\\
&=&
E_{\rvh^n}\left[
