...
\begin{figure}[h!]
 ...
 \caption{\subcri  bifurcation. $0=\dot{x}=\lam x  + x^3$.  This
 figure  comes from Ref.\cite{dynamical-fuchs}}.
 \label{fig-bifur-sub}
 \end{figure}
...
\begin{figure}[h!]
 ...
 \caption{Hysterisis arises from 2 saddlepoints. This
 figure  comes from Ref.\cite{dynamical-fuchs}.}
...
A {\bf limit cycle} is a closed trajectory with no saddlepoints
...
In limit cycles, the surface of a closed trajectory attracts
or
repels inside or outside, leading to spiraling behavior inside or outside. It's also possible for
the surface of a closed trajectory to neither attract nor repel the flow. The flow
simply runs parallel to the surface, either inside or outside the surface, or both.
