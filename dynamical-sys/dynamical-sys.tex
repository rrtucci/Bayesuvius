...
\beq
\ddot{x} + \underbrace{(2\gamma + V x^2 + R \dot{x}^2 )}_{2\tilde{\gamma}}
\dot{x} +\omega^2 x=0
\eeq
...
$\nu=\tilde{\omega}_0$ is approximately

\beq
S(\nu=\tilde{\omega}_0)\approx \frac{A^2}{2\gamma^2}
\eeq
Hence, 
...
\beq
|\tilde{x}|\propto \text{constant}
\eeq

\item $V= 0, R< 0$

\beq
|\tilde{x}|\propto \frac{1}{\omega_0^2}
\eeq

\item $V\neq, R< 0$ (V-R hybrid)

\beq
|\tilde{x}|\propto \frac{1}{V + \omega_0^2 R}
\eeq
