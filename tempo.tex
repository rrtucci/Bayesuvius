...
\item $\Gamma(M)=\{ \vec{\gamma}(\cdot)\mid   \vec{\gamma}: M \rarrow T(M)\text{ is a section}\}=$ {\bf set of all sections}. \ul{This is a vector space.}
...
vbundle section of a tangent bundle.}
