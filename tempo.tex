...
The energy-momentum tensor is replaced by 
...
In standard GR, we assume zero torsion:
...
If the {\bf stress-energy 3-form} is denoted by $\pform{\Sigma_a}{3}$, then
