...
\beq
E_{|x}\left[\frac{\rvtd^\s}{N_{1,x}}\right]
=
E_{|x}\left[\frac{\rvtd^\s}{N_x g_1(\rvx^\s)}\right]=1
\;,\;\;
E_{|x}\left[\frac{1-\rvtd^\s}{N_{0,x}}\right]
=
E_{|x}\left[\frac{1-\rvtd^\s}{N_x g_0(\rvx^\s)}\right]=1
\;.
\eeq
