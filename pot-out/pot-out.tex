...
\subsection{Monogamous strata-match}

In a monogamous strata-match,
...
E_{|x}[\rvtd^\s\rvy^\s]=
E_{|x}[\rvtd^\s\rvy^\s(1)]=
E_{|x}[\rvtd^\s]\caly_{1|1,x}
\;,
\eeq

\beq
E_{|x}[(1-\rvtd^\s)\rvy^\s]=
E_{|x}[(1-\rvtd^\s)\rvy^\s(0)]=
E_{|x}[(1-\rvtd^\s)]\caly_{0|0,x}
\;,
\eeq
...
E_{|x}[\rvtd^\s\rvy^{s(\s)}]=
E_{|x}[\rvtd^\s\rvy^\s(0)]=
E_{|x}[\rvtd^\s]\caly_{0|1,x}
\;,
\eeq

\beq
E_{|x}[(1-\rvtd^\s)\rvy^{s(\s)}]=
E_{|x}[(1-\rvtd^\s)\rvy^\s(1)]=
E_{|x}[(1-\rvtd^\s)]\caly_{1|0,x}
\;.
\eeq
Therefore,

\beq
E_{|x}\left[\frac{1}{N_1}\sum_\s \rvtd^\s 
\rvy^\s\right]
=
\caly_{1|1,x}
\eeq
...
\beq
E_{|x}\left[\frac{1}{N_0}\sum_\s (1-\rvtd^\s)
\rvy^{\s}\right]
=
\caly_{0|0,x}
\;
