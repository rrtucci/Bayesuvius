...
zero bias (i.e., $SB=0$), 
then $SDO=ATE=ATU=ATT$.

If there is a
null result 
for a RCT (i.e., $ACE=SDO=0$),
T-U symmetry (i.e., $ATT=ATU$) 
and zero bias (i.e., $SB=0$), 
then
$SDO=ATE=ATU=ATT=0$.\footnote{
It is sometimes claimed erroneously
that the null result for a RCT is  true
(i.e., $ACE=SDO=0$)
iff $ATE=0$. But in reality, 
$ACE=SDO=0$ only if ($\Leftarrow$) $ATE=0$,
$ATT=ATU$ and $SB=0$.}
