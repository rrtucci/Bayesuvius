...
ANOVA 
stands for \enquote{Analysis of Variance}.
...
$dof$ stand for
\enquote{degrees of freedom}

$SS$ stand for \enquote{Sum of Squares}

$MS$ stand for \enquote{Mean Square}
...
To determine if the difference between group means is \enquote{statistically
significant},
