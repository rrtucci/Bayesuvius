...
operations
used in Physics (Elasticity, Fluid Mechanics, General Relativity)
...
\end{enumerate}
Out of these three categories, Physics uses (1) often,
 (2) rarely and (3) almost never. ML, on the other hand, uses all three methods. This is
