...
we will usually use lower case Greek
...
T^{\beta, \gamma}
\rarrow 
\boxed{T^{\beta, \gamma}}^{0,\beta, \gamma}
\eeq
...
\boxed{
\begin{array}{l}
T^{s_0^{[n]}(\beta, \gamma), \beta, \gamma}
\\
T^{s_1^{[n]}(\beta, \gamma), \beta, \gamma}
\\
\vdots
\\
T^{s_{m-1}^{[n]}(\beta, \gamma), \beta, \gamma}
\end{array}
}^{[m],\beta, \gamma}
\eeq

\beq
{\rm index}=I^{[m], \beta, \gamma}=\boxed{
\begin{array}{l}
s_0^{[n]}(\beta, \gamma)
\\
s_1^{[n]}(\beta, \gamma)
...
T^{0,\beta, \gamma}
\rarrow
\boxed{T^{0,\beta, \gamma}}^{\beta, \gamma}
\eeq
...
\beq
[T^{[n],\beta, \gamma}, S^{[n],\beta, \gamma}]\rarrow 
T^{\alpha, \beta, \gamma}\delta_{\alpha,\alpha'} S^{\alpha',\beta, \gamma}
\eeq
