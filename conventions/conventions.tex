...
For any random
variables $\rva, \rvb, \rvx$, let

\beq
E_{|\rvx}[\rva]=\av{\rva}^{|\rvx}
\quad\text{(mean)}
\eeq
...
\av{\rva\rvb}^{|\rvx}
-
\av{\rva}^{|\rvx}\av{\rvb}^{|\rvx}
\quad\text{(covariance)}
\eeq

\beq
\s_\rva^{|\rvx} =\sqrt{\av{\rva, \rva}^{|\rvx}}
\quad \text{(standard deviation)}
\eeq

\beq
\rho_{\rva, \rvb}^{|\rvx} =\frac{\av{\rva, \rvb}^{|\rvx}}
{\s_\rva^{|\rvx} \s_\rvb^{|\rvx}}
\quad \text{(correlation)}
\eeq

\beq
\partial_\rva^{|\rvx}\rvb=
\left[\pder{}{\rva}\right]^{|\rvx}\rvb=
\frac{\av{\rva,\rvb}^{|\rvx}}
{\av{\rva, \rva}^{|\rvx}}=
\rho_{\rva, \rvb}^{|\rvx}\frac{
\s_\rvb^{|\rvx}}
{\s_\rva^{|\rvx}}
\quad\text{(partial derivative)}
\eeq
``$|\rvx$" means that the variable
$\rvx$ is held fixed
...
\left[\partial_{\rvx_i}
-
\partial^{|\rvx_i}_{\rvx_i}\right]\rvy
