...
\;.
\eeq
and for LR, $\ul{\haty}=a_0+a_1\rvx$.
...
\haty =E_{|a}[\rvy]
\eeq
Thus, $\haty$ is an unbiased estimator.
\end{claim}
\proof
...
\beq
0=\frac{d}{da} MSE = 2(-E_{|a}[\rvy]+\haty)
\frac{d\haty}{da}
\eeq
\qed
...
data consists of 
{\bf independent variables} $x^\s_1,
 x^\s_2, \ldots x^\s_n$ 
and a {\bf dependent variable} $y^\s$.
