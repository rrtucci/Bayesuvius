...
(e.g., we say $axis=i$ along $dim=0$ in $T^{i, j,k}$). 
 For a 2-dim array: (1)
...
\end{enumerate}
Out of these three categories, Physics uses (1) and (2)
\footnote{Category (2) is akin to Group Theory.} often
 but (3) rarely. ML, on the other hand, uses all three methods frequently. This is
probably due to the fact
that Physics loves linearity, and (3) does not use linear transformations, but (1) and (2) do.
