...
Bayes Rule says
\beq
\underbrace{P(\lam|x)}_{\rm posterior}=
\caln(!\lam)
\underbrace{P(x|\lam)}_{\rm likelihood}
\underbrace{P(\lam)}_{\rm prior}
\;.
\eeq

If the prior and posterior
...
&x_t\ar[d]
\\
&\stackrel{Bernoulli}{P(x_t|\lam)}\ar@/_2pc/[ld]
\\
\stackrel{Beta}{P(\lam|x_{\leq t})}\ar@/_2pc/[rd]
&&\stackrel{Beta}{P(\lam|x_{\leq t-1})}\ar@/_2pc/[ul]
\\
