...
%\includeonly{transfer/transfer,sb-removal/sb-removal, do-calc-proofs/do-calc-proofs}

%\includeonly{sb-removal/sb-removal,transfer/transfer, transfer-struc/transfer-struc}
