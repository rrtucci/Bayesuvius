...
%\includeonly{dsep-lden/dsep-lden,transport/transport, mediation/mediation, do-calc-proofs/do-calc-proofs}
...
\include{chow/chow}
\include{confounder-bds/confounder-bds}
