...
associated with Fig.\ref{fig-class-bnet}.
...
\begin{tabular}{|l|l|l|l|}
\hline
$j=$temp? & $x_j=$hot & $x_j=$med & $x_j=$cold \\ \hline
...
C4.5 (C4.5 is a successor to ID3)
