...
\section{Notation}
In this chapter,
I will often use specialized Dirac style 
bra-ket
notation to
...
A third notation that we will use for 
...
\kett{0}{D_\rvt}}_{\text{Boundary Conditions (BC) term}}
\eeqa
\end{claim}
\proof
...
Claim \ref{cl-de-diriclet-green} uses a Green's function
...
explicitly for the Green's function $G=G^--G^+$
