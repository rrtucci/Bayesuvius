...
from my blog \enquote{Quantum Bayesian Networks}.
...
conditional probabilities.
 They are not a \enquote{heuristic algorithm} like XGBoost or Neural Nets.
...
The use of the terms \enquote{causal model} and \enquote{DAG}, as an
alternative to the term
\enquote{Bayesian Network}, has become popular in the last decade
among economists, epidemiologists,
AI researchers and even Judea Pearl himself. It seems some
people think \enquote{causal models} and \enquote{DAGs} are revolutionary,
whereas Bayesian
...
When Pearl says \enquote{data}, he is referring to what is commonly called a
dataset.
...
says a \enquote{causal model}, he is referring to a DAG (directed acyclic
graph) or a
bnet
...
knowledge through \enquote{do} operator experimentation.
...
said method with the famous \enquote{Asia} bnet in Fig.\ref{fig-asia}.
...
\enquote{expert knowledge} to conclude that
...
\ref{ch-good-causal-fit}) which makes use of \enquote{do} operator
experimentation.
...
gained from posterior \enquote{do} operator experimentation.
