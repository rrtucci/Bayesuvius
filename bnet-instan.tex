...
\end{array}
\eeq
because  the left-hand side summed over $a,c$ yields 1.
This is a p-preserving operation. However, note that
this equation is {\bf promise dependent}; 
i.e., it's
...
Likewise, 
a FC instantiation 
of a bnet can be redirected without changing the promise.
...
safely assumed to be ghosts (unless you can safely prove this 
by applying the d-separation theorem
to the instantiation
prior to redirecting it.)
For example,
...
to begin with. But when redirecting, 
none of the arrows of the
redirected graph may be
safely assumed to be ghosts (unless
you can safely prove this 
by applying the d-separation theorem
to the instantiation
prior to redirecting it.)
\end{enumerate}
