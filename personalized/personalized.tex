...
because one chooses
\enquote{at random}, a subset $\Sigma$
...
labeled \enquote{multiple nodes}
...
The box labeled \enquote{multiple nodes}
...
\begin{enumerate}[(a)]
\item
Exogeneity holds iff (\enquote{4 sides can change
 color})
...
\item Strong exogeneity holds
 iff (\enquote{4 corners can change color})
...
The program
is called \enquote{JudeasRx}, in honor of Judea
Pearl.
Fig.\ref{fig-sobolev}
