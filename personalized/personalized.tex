...
of individuals $\s$ with probability
 $P(y^\s_0, y^\s_1)$.
$ACE$, on the other hand, is not
personalized, because it equals the 
difference of two averages, 
one average over an ensemble of 
individuals $\s$ with
probability
 $P(y^\s_0)$
and another average over a possibly 
different ensemble of individuals $\s'$
with
probability $P(y^{\s'}_1)$.
...
\eeq
$ATE_z$, on the other hand, 
is not well defined for a single
individual.
