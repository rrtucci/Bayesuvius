...
is the same thing as do-invisibility
of $P(\rvy_x=y)=P(\rvy=y|\cald\rvx=x)$.
But do-invisibility is a more
general concept. One can speak
of the do-invisibility of $P(y_x|z)$
or of $P(y_0, y_1, a)$, etc.
In general,
any expression with
do operators is do-invisible
