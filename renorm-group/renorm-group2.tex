...
\underbrace{
\underbrace{H(\rvy: \rvx_1 |\rvx_2, \rvx_3)}_{\leq H(\rvy: \rvx_1)}
+ \underbrace{H(\rvy:\rvx_2|\rvx_3)}_
{\leq H(\rvy:\rvx_2)}
...
{\bf normalized mutual info} $H_\rvy$
\beq
H_\rvy(\rvy: \rvx)=
...
\beq
H_\rvy(\rvy: \rvx)\leq  1
\eeq
In particular,

\beq
H_\rvy(\rvy:\rvx_1, \rvx_2, \ldots,\rvx_n)
\leq 1
\eeq

Dividing Eq.(\ref{eq-mi-right bd}) by $H(\rvy)$ we get
\beq
\max_i H_\rvy(\rvy: \rvx_i) \leq H_\rvy(\rvy:\rvx_1, \rvx_2, \ldots, \rvx_n)
\leq \sum_{i=1}^n H_\rvy(\rvy:\rvx_i)
\eeq
