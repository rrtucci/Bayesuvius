...
\ecen
$$
\caption{Cubic Lattice for $D=1$ (with 4 spins) and $D=2$ (with 9 spins) Ising model.}
\label{fig-ising-1-2}
\end{figure}
...
$T_c= 1/\beta_c=$ Curie Temperature (a.k.a. critical temperature). Magnetization $\av{\rvS_i}$ is non zero for $T< T_c$ (spontaneous magnetization) ])and zero for $T>T_c$ (disordered phase).
