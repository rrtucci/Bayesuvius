...
given $g_j$ and
$\ln (p'/p)$, one can find the value of
$g'_j$.
...
If you keep $\mu$
(or $\Lambda$) fixed and
allow $p$ to vary, then
$d\ln(p\mu)$ (or $d\ln(p\Lambda)$ )
can be replaced by $d\ln p$.
...
at ultra-high energy scales $p= b=1$.
The dressed c.c.'s
