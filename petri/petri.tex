...
$\kappa(\cdot)$ to $\ol{\cala}$ and define $\kappa(a) = 0$
...
(exiting $\rvp_i$);
else $W^{\rvp\rarrow}_{i,j} = 0$. More generally, in the case a capacity function $\kappa(\cdot)$ is given, let
...
(entering $\rvp_i$);
else $W^{\rvp\larrow}_{i,j} = 0$. More generally, in the case a capacity function $\kappa(\cdot)$ is given, let
