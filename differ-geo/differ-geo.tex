...
$f(x)= f(\phi)$ (as they do in Thermodynamics, were they
...
statements more symmetrical too. (for example, $(\phi^*U)(P, T)$ looks better than $U(\phi(P, T))$.\;).
...
\beq
\pback{\vecX}{\vec{u}(t)}\ul{\omega_\mu}(\rvX)=0
\eeq
