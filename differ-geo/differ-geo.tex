...
The main source for this chapter was ChatGPT and  a book by Schutz. %**************\cite{schutz}. 
The book by Schutz is not a great favorite of mine.
I did find its choice of topics helpful in mapping the subject and in formulating questions to ask ChatGPT about it. There is a plethora of books on the subject
of Differential Geometry (DG), alternatives  to Schutz,
ranging from 
non-rigorous books
...
This makes the learning curve for DG, which is steep
to begin with, steeper than it needs to be, in my opinion. 
In this chapter,
...
Also, there are many current efforts (including my own Mappa Mundi)
to add causal inference to 
LLMs and I expect the machinery
of DG will
