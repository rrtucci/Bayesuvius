...
\cellcolor[HTML]{9AFF99}vector field & \begin{tabular}[c]{@{}l@{}}$X$ or, more explicitly, $X_\pi$\\ where $\pi\in M$.  Replace $\pi$ by $g$\\ when manifold $M$ is group $G$\end{tabular} & \begin{tabular}[c]{@{}l@{}}$\vecX$ or, more explicitly, $\vecX_\pi$\\ where $\pi\in M$. Replace $\pi$ by $g$\\ when manifold $M$ is group $G$\end{tabular} \\ \hline
