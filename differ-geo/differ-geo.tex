...
\cellcolor[HTML]{9AFF99}\begin{tabular}[c]{@{}l@{}}coordinate\\ (holonomic) t-basis\end{tabular} & $\check{x}_i$ & $\hat{x}_i$, e.g., $(\hat{x}, \hat{y})$ \\ \hline
\cellcolor[HTML]{9AFF99}non-holonomic t-basis & $\vece_i$ & $\hat{e}_i$, 
