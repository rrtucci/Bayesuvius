...
Let $\calm\caly_{c|\td}(t)$ denote the
{\bf measured $\caly_{c|\td}(t)$}.
...
\left\{
\begin{array}{ll}
\caly_{0|\td}(t_0)&\text{if $t=t_0$}
\\
\caly_{\td|\td}(t_1)&\text{if $t=t_1$}
\end{array}
\right.
\eeq
Note that $c=c(t)$; $c=0$ if $t=t_0$
and $c=\td$ if $t=t_1$. Now we claim that the DID 
...
&=
\left[
\Delta_t \calm\caly_{c|1}(t)
-\Delta_t \calm\caly_{c|0}(t)
\right]
\\
&=
\left[
...
\right]
-\left[
\Delta_t \calm\caly_{c|0}(t_1)
-
\Delta_t \calm\caly_{c|0}(t_0)
\right]
\\
&=
...
$\Delta_c c=1$, one gets

\beq
\delta=\Delta_c\Delta_t 
\calm\caly_{c|\td}(t)=
\Delta_c\Delta_t y^\s_t=
(m_1-m_0)\Delta t
\;.
\eeq
...
\rowcolor[HTML]{ECF4FF} 
 & $t=t_0$ & $t=t_1$ \\ 
\hline
$c=1$ \cellcolor[HTML]{ECF4FF}& $\caly(S_1)=\caly_{1|0}(t_0)$ & $\caly(F_1)=\caly_{1|1}(t_1)$ \\ 
\hline 
$c=0$\cellcolor[HTML]{ECF4FF} & $\caly(S_0)=\caly_{0|0}(t_0)$ & $\caly(F_0)=\caly_{0|0}(t_1)$ \\ 
\hline 
\end{tabular}
}
\caption{
