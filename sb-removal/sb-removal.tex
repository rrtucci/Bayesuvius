...
the right-hand side might be do-weak.
If there are no hidden variables,
they are always do-weak, but they might not be
 in the presence of hidden variables. If they
are do-weak, we will say that the query
