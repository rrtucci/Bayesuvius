...
the right-hand side might be do-visible. If there are no hidden variables,
they are always do-invisible, but they might not be
 in the presence of hidden variables. If they
are do-invisible, we will say that the query
$P(y|\cald\rvx=x)$ is adjustable via $\rva.$
