...
Coherent/Incoherent Type 1 FFL (C1-FFL/I1-FFL) if $K_{y\rarrow z}$ is highpass/lowpass.
...
or a square pulse function (in purple).}
...
\\
z_0 e^{-\alp_3 t}
& \text{if $x$ step down, $y(0)=y_0$, $y< K_{y\rarrow z}$
}
\end{array}
\right.
\eeq
...
or a square pulse rising from 0 at time $t=0$
