...
&
\xymatrix{
&\Rect{\rvx}\ar[dl]|{\color{red}\;+\;}
\ar[dr]|{\color{red}\;+\;}
\\
\Rect{\rvy}\ar[rr]|{\color{red}\;+\;}
&&\Rect{\rvz}
}
&
&
...
Coherent/Incoherent Type 1 Feed Forward Loop (C1-FFL/I1-FFL) if $\beta_\rvz>0/\beta_\rvz<0$.
All other parameters (i.e., $\alp_\rvy, \alp_\rvz, \beta_\rvy$) are positive.
...
$$
\caption{C1-FFL/I1-FFL bnet
if $\beta_\rvz>0/\beta_\rvz<0$.}
