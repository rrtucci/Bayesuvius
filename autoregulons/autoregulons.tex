...
{\bf Highpass filter, activator} Hill function
 \beq
 h_{\oplus}(x)
 ...
 ({\bf Lowpass filter, repressor}) Hill function
 \beq
  h_{\ominus}(x)=\beta\frac{1}{1 + \left(\frac{x}{K}\right)^n}
  \eeq
...
Autoregulon net motif and the 2 symbols that we will
...
\left\{
\begin{array}{l}
\cald\rvx = h_\rvx(x) + \gamma_{\rvy\rarrow\rvx}\;y
\\
\cald\rvy = h_\rvy(y) +\gamma_{\rvx\rarrow\rvy}\;x
\end{array}
\right.
\eeq
...
\left\{
\begin{array}{l}
\cald x = h_\rvx(\rvx) + g_\rvx(x, y)+ \gamma_{\rvy\rarrow\rvx}\;y
\\
\cald y = h_\rvy(\rvy) + g_\rvy(x, y) + \gamma_{\rvx\rarrow\rvy}\;x
\end{array}
\right.
\eeq
