...
of genomics, you might find Prologue \ref{ch-genomics-vocab} helpful.
...
Note that if $\alp t\ll 1$, then\footnote{Use $e^x\approx 1 + x$ for $|x|\ll 1$.},
...
\eeq
We will approximate $|p_i-1|\ll 1$ so
...
Alon's book Ref.\cite{alon-book} and Prologue \ref{ch-genomics-vocab} helpful.
...
producing 
mRNA is called a transcription. Transcriptions are copies,
not extemporaneous creations. TL, on the other
hand, does not produce a faithful copy
of the original; that is why it's called a translation.
