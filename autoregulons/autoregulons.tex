...
\caption{$\dot{x}(t)=\beta-\alp x$ is normal.
...
\caption{$(x, \dot{x})$ graphs and 
corresponding $(x,t)$ graphs for the case of
two repelling and one attracting (fixed point) points.}
