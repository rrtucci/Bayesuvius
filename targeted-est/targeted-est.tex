...
and call it $\call=\call(\beta, y, \haty, \eps)$.
...
and then the limit $\eps\rarrow 0$ occurs
 as $N\rarrow  \infty$.
 When $\eps$ is taken to be a finite power
 of $1/N$, it is called the {\bf fluctuation parameter}.
...
\begin{enumerate}
\item Estimate expected value $\haty(d,w)=\caly_{|d,w}$ of outcome $y$
