...
The components of $y_i$ will be denoted by $(y_i)_\gamma$ for $\gamma=1,2, \ldots, nc$.

$\rvx_i\in \RR^{nb\times 1}$ for $i=1, 2, \ldots nc$ are column vectors of $\rvX$. The components of $x_i$ will be denoted by $(x_i)_\gamma$ for $\gamma=1,2, \ldots, nc$.
...
,\eps_i$.
and $\rvx_i$.
We can make that index explicit if the situation calls for it, as  when the index is being summed over.
