...
``causally correct (CC) bnet" instead. Pearl defines a causal bnet to be
...
{\bf Observational data} is 
another word for a 
dataset with a fixed
set of features;
it's data collected without
assuming a particular 
DAG (i.e., causal structure, causal model).
 {\bf Experimental data} 
is data whose purpose 
is to discern 
between various 
possible DAGs, often  
related by do interventions.
