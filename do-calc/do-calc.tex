...
\end{figure}
Fig.\ref{fig-fsm-do-calc} gives a finite state machine
...
$$\text{Rule 2: }\call_{\rva.}\cald_{\rvr.}G: 
\begin{array}{cccc}
\NodeZeroOut{\rva.} 
&
\NodeZeroNone{\rvb.}
...
$$\text{Rule 3: }\cald_{\rva.-an(\rvs.)}\cald_{\rvr.}G:
\begin{array}{ccccc}
\xymatrix@C=.2pc{
&&&&&&&
an(\rvs.)\ar[dlllll]\ar[drr]
&&&&&&&&
\\
&&\bullet&&&\bullet&&&&\bullet&&\bullet\ar@/_1pc/[llllll]&&&&
\\
&\rva.'\rva.''\ar@{<-}[ul]|{\color{red}0}\ar@{<-}[ur]\ar[dl]\ar[dr]
&&&\rvb.\ar@{<-}[ul]\ar@{<-}[ur]\ar[dl]\ar[dr]
&&&\cald\rvr.\ar@{<-}[ul]|{\color{red}0}\ar@{<-}[ur]|{\color{red}0}\ar[dl]\ar[dr]
&&&\rvs.\ar@{<-}[ul]\ar@{<-}[ur]\ar[dl]\ar[dr]
\\
&&&&&&&&&&&&&&&}
\end{array}
$$
