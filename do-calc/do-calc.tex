...
that violate the 2 patrs of the backdoor adjustment criterion.
 The reason for part 2 is that
 if we condition on node $\rvz.$
 in accordance with part 1, we open the
...
$$
\caption{The red arrows in this figure define paths 
that violate the 3 parts of the frontdoor adjustment criterion.}
