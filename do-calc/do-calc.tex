...
Note that Rules 1 and 3 describe 
situations with zero information transmission
between nodes $\rva$ and $\rvb$,
whereas Rule 2 says two graphs have equal information
transmission between nodes $\rva$ and $\rvb$.
