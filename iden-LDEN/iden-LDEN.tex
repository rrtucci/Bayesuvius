...
a particular DAG is do-weak, is by using Pearl's
...
whether a
do query for that DAG is do-weak or not. Hence, SCuMpy
...
of whether a do query is do-weak
...
$P(y|do(x))$ is still known to be do-weak for this DAG.
