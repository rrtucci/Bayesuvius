...
a particular DAG is do-invisible, is by using Pearl's
...
whether a
do query for that DAG is do-invisible or not. Hence, SCuMpy
...
of whether a do query is do-invisible
...
$P(y|do(x))$ is still known to be do-invisible for this DAG.
