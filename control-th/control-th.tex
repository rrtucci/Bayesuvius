\chapter{Control Theory (linear, deterministic): COMING SOON}
\label{ch-control-th}
...
\section{Classical model (continuous)}

classical model = convolution boxes
...
\section{Modern model (continuous) }



Modern CT model = state space model
...
\eeq
 ...
 \section{Classical model (discrete)}
 ...
 \section{Modern model (discrete)}
 
 \subsection{Discretizing continuous case}
...
\right.
\eeq
Transfer matrix $\TIL{H}_{y|u}(z)$. Assuming $x^{[0]}=0$, 
