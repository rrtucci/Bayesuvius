...
\enquote{digital} or \enquote{sampled} to
describe a theory with discretized $t$,
but continuous $x$. 
Sometimes,
the word \enquote{digital}
...
and $(c)$ a \enquote{rolled} dynamical bnet
...
in 1942
to model \enquote{differential equation machines}.
They were later 
