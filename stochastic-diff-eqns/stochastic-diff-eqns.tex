...
For $\rvx_1, \rvx_2\in \RR$,

\beqa
d(\rvx_1 \rvx_2)&=&
(\rvx_1 +d\rvx_1)(\rvx_2 + d\rvx_2)-\rvx_1\rvx_2
\\
&=&
\rvx_1d\rvx_2 +\rvx_2d\rvx_1
+
d\rvx_1d\rvx_2
\eeqa
...
and Dol\`{e}ans-Dade (DD) exponential
...
\exp(
\ell_t -\ell_0 
-\frac12\underbrace{\av{\ell_\tau,\ell_\tau }_0^t}_{\s^2 t}
)
\eeq
\item In the previous example, assume $\mu$ and 
$\s$ depend on time, but smoothly. Then
\beq
