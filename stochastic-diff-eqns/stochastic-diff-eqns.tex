...
\beq
\frac{P(x_{1\ldots N})}{P(y_{1\ldots N})}=
\exp\left(-\;
...
From Eq.(\ref{eq-px-div-pb-source})
\beq
\frac{P(x_{1\ldots N})}{P(y_{1\ldots N})}=
\exp\left(-\;
\frac{1}{2q}\int_0^{t_N}dt
...
E[h(\rvx_{1\ldots N})]
&=&
\int \underbrace{dy_{1\ldots N} ZP(y_{1\ldots N})
}_
{dx_{1\ldots N}P(x_{1\ldots N})}
\underbrace{h(y_{1\ldots N})}_
{h(x_{1\ldots N})}
\\
&=&
E[Zh(y_{1\ldots N})]
