...
\section{Martingales and Semi-Martingales}
...
\section{Stochastic Calculus of It\^{o}
and Stratonovich}

Consider the 1 dimensional case $\rvx, \dot{\rvB}\in \RR$.
\beq
\frac{d\rvx}{dt}= f(\rvx, t) + L(\rvx, t)\dot{\rvB}(t)
\eeq
...
Consider the integrand $L(x,t)\dot{\rvB}(t)$.
...
In the SDE case, the integrand $L\dot{\rvB}$ is continuous
