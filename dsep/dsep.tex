...
Note that
$(\rva.\perp_G
nde(\rva.)\mid pa(\rva.))$ and
$(\rva.\perp_G
nde(\rva.)-pa(\rva.)\mid pa(\rva.))$
are
equivalent
because
$H(\rva:\rvb, \rvc|\rvc)=
...
\\
\phi: \rva.\perp_G nde(\rva.)\mid pa(\rva.)
&\mapsto&
\rva.\perp_P nde(\rva.)\mid pa(\rva.)
\eeqa
In general, this map
is 1-1 but not onto.
