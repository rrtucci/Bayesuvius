...
redundancy: in series connection (as in more layers in a feedforward NN),
and in parallel connection (as in more 
tranet heads, and more bnet plates (see Chapter \ref{ch-plates})).
