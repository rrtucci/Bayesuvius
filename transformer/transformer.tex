...
\beq
F(e^{\delta, \alp}) = \sum_{\Delta'} W_2^{\delta, \Delta'}ReLU\left(\sum_{\delta'}
...
\cellcolor[HTML]{FFFFC7}\begin{tabular}[c]{@{}l@{}}$d$\\ {\tt hidden\_size}\end{tabular} & 768 & 768 \\ \hline
