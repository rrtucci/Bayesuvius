...
In the next chapter (Ch. \ref{ch-renorm-group2})
we discuss how to
...
high energy (ultraviolet) regime theory, whereas
the point $b=\infty$, $\calp=0$
corresponds to a macroscopic,
low energy (infrared)
regime theory.\footnote{Hence, it is convenient to think of $b$ as akin to $\beta$
...
\caption{RG scaling of length $\delta x$
and energy $\delta E$ intervals for $b>1$.}
...
pieces $\ln(q'/q)$ divided by log of magnificatio $\ln(b)$ . See
Ref.\cite{wiki-fractal}}
