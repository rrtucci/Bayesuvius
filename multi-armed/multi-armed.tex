...
Define the
{\bf Instantaneous (at time $t$) Regret (I-Regret)} by
...
\;.
\eeq
Define the {\bf Cumulative Reward (C-Reward)} by

\beq 
CRew_t= E_{|\rva_t=a}[(t+1)\rho_t]
\;.
\eeq
