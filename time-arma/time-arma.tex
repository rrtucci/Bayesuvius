...
\eeq($\alp$ stands for
the first  letter
of \enquote{auto-regressive}.
$\nu$ stands for first
 letter of \enquote{noise}.)
...
the \enquote{orthogonal projection}
...
Henceforth, we  will
abbreviate
\enquote{{\bf differencing}} by \enquote{
{\bf diff}}.
...
postulating a \enquote{quasi} log
 likelihood function
$ LL(\theta)$,
and
maximizing
...
{\bf Quasi-Maximum Likelihood Estimate
 (QMLE)}.
The reason for
using the prefix \enquote{quasi}
...
(i.e., a \enquote{stochastic}
 average by an \enquote{ergodic} average.)
