...
\begin{figure}[h!]\centering
	$$\xymatrix@C=5pc@R=5pc{
		&*+[F*:SpringGreen]{\ul{dV}}
\ar@/^3.5pc/[ddd]|{\partial_VT}
\ar@/_1pc/[dddd]\ar[ddddr]\ar[dl]|{-p=\partial_V U}&*+[F*:SpringGreen]{\ul{d\{N_i\}}}\ar[ddddr]\ar[dll]|{\mu_i=\partial_{N_i}U}&
		\\
		*+[F*:SpringGreen]{\ul{dU}}\ar@/_1pc/[dddrrr]\ar[ddd]\ar[dddr]\ar[dddrr]&&*+[F*:Lavender]{\ul{dS}}
\ar[dd]|{\partial_Sp=-\partial_VT}
\ar[dddr]\ar@/_1pc/[dddll]\ar[dddl]\ar[ll]|{T=\partial_SU}&
		\\
		&&&
		\\
		&*+[F*:Lavender]{\ul{dT}}
\ar[r]|{\partial_Tp\;=\alp/\kappa_T}
\ar[uul]|{C_V=\partial_T U}
\ar[dr]|{C_p=\partial_TH}
\ar[uuu]|{\alp V=\partial_T V}
\ar[drr]\ar[dl]\ar[d]&*+[F*:Lavender]{\ul{dp}}
\ar@/^1pc/[d]|{\partial_pH}
\ar[dl]\ar[d]&*+[F*:Lavender]{\ul{d\{\mu_i\}}}\ar[d]
		\\
		*+[F*:SkyBlue]{\ul{dF}}&*+[F*:SkyBlue]{\ul{dG}}&*+[F*:SkyBlue]{\ul{dH}}&*+[F*:SkyBlue]{\ul{d\Phi}}
	}$$
	\caption{Delta bnet for Thermodynamics obtained from Fig.\ref{fig-texnn-for-thermo}.}
	\label{fig-thermo-delta-bnet}
\end{figure}

If we take the differential of
every node in  Fig.\ref{fig-texnn-for-thermo},
we get the \qt{delta bnet}
shown in Fig.\ref{fig-thermo-delta-bnet}.
