...
\item Using non-p-preserving operations
to simplify an instantiation.
This removes memory of
how the instantiation was built (modulus p-preserving operations which are not recorded). 
\end{enumerate}
A way to 
...
to begin with. But redirecting 
an FC graph unghosts all its arrows.
\end{enumerate}
\end{mybluearea}
...
\item Use the basic p-preserving operations to
