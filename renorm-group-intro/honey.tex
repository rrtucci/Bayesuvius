...
\usepackage{honey}
\begin{document}
\title{Honey, I Shrunk the Theory}
...
The dependence of $\xi$ on temperature
...
\begin{figure}[h]
    \begin{center}
    \epsfig{file=cp.eps, height=2.7in}
...
Fig.1 shows the typical behavior
...
\bibitem{Mc}
W.D. McComb, ``Renormalization Methods: A Guide For Beginners",
(Oxford, 2007).

\bibitem{Go}Nigel Goldenfeld,
``Lectures on Phase Transitions
and the Renormalization Group" (Westview Press, 1992)

\bibitem{Sr}Mark Srednicki,
``Quantum Field Theory",
(Cambridge Univ. Press, 2007)

\bibitem{wiki-rg}
{\tt http://en.wikipedia.org/wiki/Renormalization\_group}

\bibitem{wiki-fractal}
{\tt http://en.wikipedia.org/wiki/Fractal\_dimension}

\bibitem{wiki-da}
{\tt http://en.wikipedia.org/wiki/Dimensional\_analysis}


\bibitem{wiki-landau-pole}
{\tt http://en.wikipedia.org/wiki/Landau\_pole}


\bibitem{wiki-scale-inv}
{\tt http://en.wikipedia.org/wiki/Scale\_invariance}
