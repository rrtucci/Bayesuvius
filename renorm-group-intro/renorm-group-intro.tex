...
A fine book by a High Energy Physicist on RG theory is Ref.\cite{Sr}
...
The set of points that are repelled by the critical point is called the {\bf unstable manifold}.
As a consequence
...
\item RG for Bayesian Networks, Chapter \ref{ch-renorm-group-bnets}
\end{enumerate}
