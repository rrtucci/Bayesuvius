...
to be self-similar at a fixed point $F^*$, comes from the fact that the RG transformation $R_b$ acting on $F$ satisfies
...
As an example,
consider the connected Green's function $G_c(x) = \av{\phi(x), \phi(0)}$.
At  a fixed point
