...
\section{Introduction}
 ...
 describes how parameters scale
...
although I think some aspects of it
...
Finally, I recommend Ref.\cite{Sr}
by Srednicki. It's
...
all from a High Energy Physics point of view.
...
$\frac{xa}{x_0 a_0}$ remains constant. So 
...
$a'=ba$ instead of $a=ba_0$. 
Alternatively, one could write $a_{i+1}=ba_i$, for
...
set the engineering and fractal dimensions
...
If $R_b$ denotes
a {\bf renormalizaton transformation (iteration) 
...
of the beta function
in powers of $g_j$)
must equal the engineering dimension of
