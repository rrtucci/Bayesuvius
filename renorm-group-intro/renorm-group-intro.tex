...
\label{eq-L-scaling}
\eeq
For example, $x_0 = L\frac{x_0}{L}$ so $D_x=1$

Define {\bf RG $b$-scaling} of a function $F(x, p)$ by
\beq
F(x_0, p_0)= b^{-y_F}F(x_0/b, bp_0)
\label{eq-b-scaling}
\eeq
For example, $x_0 = b\frac{x_0}{b}$ so $y_x=-1$.
...
For example, for $1<d< 4$, the $\phi^4$ theory
